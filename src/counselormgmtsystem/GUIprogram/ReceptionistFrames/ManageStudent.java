...
public class ManageStudent extends javax.swing.JFrame {
    ...
    public void initStudentTable() {
        ...
        studentTable.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                if (selectedRow != -1) {
                    // Grab the Student ID from Column 0 of the clicked row
                    String studentID = model.getValueAt(selectedRow, 0).toString();
                    
                    // Search FileHandler.userList for this specific student
                    for (User u : FileHandler.userList) {
                        if (u.getID().equals(studentID) && u instanceof Student s) {
                            // Populate all the text fields on the left!
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        if (name.isEmpty() || username.isEmpty() || password.isEmpty() || intake.isEmpty() || email.isEmpty() || contact.isEmpty()) {
