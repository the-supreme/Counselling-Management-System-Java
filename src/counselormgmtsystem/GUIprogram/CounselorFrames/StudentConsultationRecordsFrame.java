...
public class StudentConsultationRecordsFrame extends javax.swing.JFrame {
     ...
     */
   public StudentConsultationRecordsFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 44, 430, 410));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 40, 390, 420));

        addButton.setBackground(new java.awt.Color(255, 255, 51));
        addButton.setForeground(new java.awt.Color(0, 0, 0));
        addButton.setText("Add  Record");
        addButton.addActionListener(this::addButtonActionPerformed);
        jPanel1.add(addButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 460, 180, -1));

        updateButton.setBackground(new java.awt.Color(0, 0, 128));
        updateButton.setForeground(new java.awt.Color(255, 255, 255));
        updateButton.setText("Update Record");
        updateButton.addActionListener(this::updateButtonActionPerformed);
        jPanel1.add(updateButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 460, 120, -1));

        deleteButton.setBackground(new java.awt.Color(255, 0, 0));
        deleteButton.setForeground(new java.awt.Color(255, 255, 255));
        deleteButton.setText("Delete Record");
        deleteButton.addActionListener(this::deleteButtonActionPerformed);
        jPanel1.add(deleteButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 460, -1, -1));

        jLabel9.setText("jLabel9");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 460, -1, -1));

        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8-note-50.png"))); // NOI18N
        jLabel11.setText("jLabel11");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 0, 50, 40));
    ...
    private void populateTable() {
        ...
        for (ConsultationRecord record : FileHandler.consultList) {
    ...
    private void populateFormFromSelection() {
        ...
        if (selectedRow >= 0) {
            ConsultationRecord record = FileHandler.consultList.get(selectedRow);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new StudentConsultationRecordsFrame().setVisible(true));
    }
