...
public class adminManageRecep extends javax.swing.JFrame {
    ...
    private String columnName[] = {"ID", "Full Name","Contact Number","Email"};
    ...
    private void initComponents() {
        ...
        jPanel1.add(contactTf, new org.netbeans.lib.awtextra.AbsoluteConstraints(213, 85, 71, -1));

        nameTf.addActionListener(this::nameTfActionPerformed);
        jPanel1.add(nameTf, new org.netbeans.lib.awtextra.AbsoluteConstraints(213, 51, 71, -1));

        emailTf.addActionListener(this::emailTfActionPerformed);
        jPanel1.add(emailTf, new org.netbeans.lib.awtextra.AbsoluteConstraints(213, 119, 71, -1));
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 54, 76, -1));

        jLabel2.setText("Contact Number");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 88, -1, -1));

        jLabel3.setText("Email");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 122, 37, -1));

        jLabel4.setText("Password");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 156, -1, -1));

        passwordTf.setText("jPasswordField1");
        jPanel1.add(passwordTf, new org.netbeans.lib.awtextra.AbsoluteConstraints(213, 153, 71, -1));
    ...
    private void loadReceptionists() {
        ...
        for (User u : FileHandler.userList) {
            if (u instanceof Receptionist) {
                ...
                model.addRow(new Object[]{r.ID, r.fullName, r.contactNumber, r.email});
            }
        }
        clearFields();
    }
    ...
    private void editBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBtnActionPerformed
        if (selectedReceptionist == null) {
            ...
            String errorMessage = currentAdmin.validateData(nameTf.getText(), contactTf.getText(), emailTf.getText(), pw, false, selectedReceptionist.ID);
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        String pw = new String(passwordTf.getPassword());
            ...
            String errorMessage = currentAdmin.validateData(nameTf.getText(), contactTf.getText(), emailTf.getText(), pw, true, null);
