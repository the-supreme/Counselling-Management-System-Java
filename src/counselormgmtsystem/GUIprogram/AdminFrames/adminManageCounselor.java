...
public class adminManageCounselor extends javax.swing.JFrame {
    ...
    private String[] columnName = new String[]{"ID", "Full Name", "Contact Number", "Email", "Specialisation"};
    ...
    private void loadCounselors() {
        ...
        for (User u : FileHandler.userList) {
            if (u instanceof Counselor c) {
                counselorRefs.add(c);
                model.addRow(new Object[]{c.ID, c.fullName, c.contactNumber, c.email, c.specialization});
            }
        }
        clearFields();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(editBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(132, 261, -1, -1));

        deleteBtn.setBackground(new java.awt.Color(255, 51, 51));
        deleteBtn.setForeground(new java.awt.Color(255, 255, 255));
        deleteBtn.setText("Delete");
        deleteBtn.addActionListener(this::deleteBtnActionPerformed);
        jPanel1.add(deleteBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(222, 261, -1, -1));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(67, 184, -1, -1));
        ...
        jPanel1.add(addBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(42, 261, -1, -1));
    ...
    private void editBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBtnActionPerformed
        ...
        String errorMessage = currentAdmin.validateData(nameTf.getText(), contactTf.getText(), emailTf.getText(), pw, false, selectedCounselor.ID);
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        Counselor newC = new Counselor(
            newID, username, pw, nameTf.getText().trim(), specialisationTf.getText().trim(), contactTf.getText().trim(), emailTf.getText().trim() 
        );
