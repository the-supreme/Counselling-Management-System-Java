...
public class ConsultationRecord {
    ...
    public ConsultationRecord(String recordID, String appointmentID, String studentID,
    ...
    public static void viewRecordsByCounselor(ArrayList<ConsultationRecord> consultList, String counselorID) {
        System.out.println("===== Consultation Records for " + counselorID + " =====");

        for (ConsultationRecord record : consultList) {
    ...
    public void addToConsultationList(ArrayList<ConsultationRecord> consultList) {
